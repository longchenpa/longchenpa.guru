...
```
4) Тексти [txt], глави [cha] і змісти [toc] повинні нумеруватися 3-значиними цифровими префіксами з нулями і пробілом "XXX ". Якшо [cha] є показчикм в середині тексту то нумерація має бути три мінуси "---", якшо [cha] є самостійним текстом, то номером тексту.
...
Приклад, де [cha] є лиш показчиками

```
003 kha byang nyi ma'i snying po/ [txt] (75-134)
--- (kha byang) kha byang nyi ma'i snying po/ [cha] (76-84) Circle of the Sun, Inventory to the Lama Yangtik ཁ་བྱང་ཉི་མའི་སྙིང་པོ་བཞུགས་སོ།
--- (lo rgyus) lo rgyus rin po che'i phreng ba/ [cha] (84-134) The Jewel Rosary History
--- (rnam thar) rgyal ba zhang ston gyi rnam thar/ [cha] (103-107) Biography of Gyalwa Zhangtön ལོ་རྒྱུས་རིན་པོ་ཆེའི་ཕྲེང་བ་ལས། རྒྱལ་བ་ཞང་སྟོན་གྱི་རྣམ་ཐར
```
